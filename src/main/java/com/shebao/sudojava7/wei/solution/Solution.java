package com.shebao.sudojava7.wei.solution;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String str = "861073504704502638325648901539000807048039056602854193056197082213085769900300015";
        long start = System.currentTimeMillis();
        System.out.println(start);
        char[][] array = getArray(str);
        solveSudoku(array);
    ...
    public static char[][] getArray(String str){
        ...
        for (int i = 0; i < 9; i++) {
            String lineStr = str.substring(9 * i, 9 * i + 9);
    ...
    static int fill_state(char[][] board){
        int cnt = 0;    //统计board数组空格(split)的个数
        for(int i = 0; i < N; i++){
            for(int j = 0; j < N; j++){
                if(board[i][j] != split){
                    int t = board[i][j] - '1';
